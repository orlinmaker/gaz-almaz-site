        ...
        <div className="grid gap-8 lg:gap-12 md:grid-cols-2 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col">
            ...
            {(priceBuy || priceExchange || fallbackPrice) && (
              <div className="mb-8 glass-effect px-6 py-5 rounded-xl border-2 border-primary/20 w-fit space-y-3">
                {priceBuy ? (
                  <div className="flex items-center gap-3">
                    <span className="text-sm text-muted-foreground">Цена при покупке:</span>
                ...
                {priceExchange ? (
                  <div className="flex items-center gap-3">
                    <span className="text-sm text-muted-foreground">Цена при обмене:</span>
