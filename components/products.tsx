  ...
  const products: Product[] = [
    {
      ...
      icon: Crown,
      description: "160 шаров",
      features: ["Продажа 13 000 ₽", "Обмен 7 500 ₽"],
      price: "от 7 500 ₽",
    ...
    },
    {
      ...
      icon: Zap,
      description: "90 шаров",
      features: ["Продажа 7 000 ₽", "Обмен 5 000 ₽"],
      price: "от 5 000 ₽",
    ...
    },
    {
      ...
      icon: Star,
      description: "30 шаров",
      features: ["Продажа 2 700 ₽", "Обмен 2 500 ₽"],
      price: "от 2 500 ₽",
      featured: true,
    ...
    },
    {
      ...
      icon: Sparkles,
      description: "50 шаров",
      features: ["Продажа 5 000 ₽", "Обмен 4 000₽"],
      price: "от 4 000 ₽",
