      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
            ...
            только лучшие медицинские газы для вашего комфорта и удовольствия.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4 text-pretty leading-relaxed">
                Мы специализируемся на поставке медицинских газов премиум качества для легального развлекательного
